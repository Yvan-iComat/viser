...
/** One custom toolbar button, as carried by ToolbarConfigMessage. */
export type ToolbarButton = ToolbarConfigMessage["buttons"][number];

/** Configuration for the horizontal toolbar at the top of the 3D view. */
...
export interface GuiState {
  ...
  /** Timeline slider state (TimelineMessage), or null when no timeline is
   * shown. */
  timeline: TimelineMessage | null;
  /** Horizontal toolbar configuration (ToolbarConfigMessage), or null for the
   * default toolbar. */
