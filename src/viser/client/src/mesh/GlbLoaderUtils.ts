      ...
      (gltf) => {
        ...
        gltf?.scene.traverse((obj) => {
          if (obj instanceof THREE.Mesh) {
            // Merge duplicated vertices so computeVertexNormals averages
            // normals across shared vertices (smooth shading). Delete stale
            // normals first to force recomputation.
